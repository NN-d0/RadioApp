...
export function getMonitorStationListApi() {
  return doCoreGet('/api/core/app/monitor/stations')
}

export function getLatestMonitorDataApi(stationId) {
  return doCoreGet('/api/core/app/monitor/latest', { stationId })
}