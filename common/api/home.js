...
export function getAppHomeSummaryApi() {
  return doCoreGet('/api/core/app/home/summary')
}

export function getAppHomeLatestAlarmsApi(params) {
  return doCoreGet('/api/core/app/home/latest-alarms', params || {})
}

export function getAppHomeAlarmDetailApi(id) {
  return doCoreGet('/api/core/app/home/alarm/detail', { id })
}